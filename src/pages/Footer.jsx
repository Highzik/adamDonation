                ...
                <div className="row">
                    ...
                    <div className="col-md-6 col-lg-6">
                        <ul className='p-0'>
                            ...
                            <li className='mb-3'><span className="icon icon-map-marker"><FaMapMarker style={{ color: '#79ccab', fontSize: '1rem', marginRight: "10px" }} /> 203 Fake St. Mountain View, San Francisco, California, USA</span></li>
                            <li className='mb-3'><a href="#"><span className="icon icon-phone text-white"><FaPhone style={{ color: '#79ccab', fontSize: '1rem', marginRight: '10px' }} /> +2 392 3929 210</span></a></li>
                            <li className='mb-3'><a href="#"><span className="icon icon-envelope text-white"><FaEnvelope style={{ color: '#79ccab', fontSize: '1rem', marginRight: "10px" }} />   info@yourdomain.com</span></a></li>
