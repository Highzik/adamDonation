import UN3 from '/src/images/UN3.webp'
...
import UN2 from '/src/images/UN2.jpeg'
        ...
        <div className="site-section fund-raisers">
          <div className="container">
            ...
            <div className="row">
              ...
              <div className="col-md-6 col-lg-3 mb-5">
                <div className="person-donate text-center bg-light pt-4">
                  <img src={image4} alt="Image placeholder" className="img-fluid" />
                  <div class="donate-info">
              ...
              <div className="col-md-6 col-lg-3 mb-5">
                <div className="person-donate text-center bg-light pt-4">
                  <img src={image5} alt="Image placeholder" className="img-fluid" />
                  <div class="donate-info">
